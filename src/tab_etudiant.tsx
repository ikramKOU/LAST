        ...
        <div className="container-fluid page-body-wrapper">
          <nav className="sidebar sidebar-offcanvas" id="sidebar">
            <ul className="nav">
              ...
              <li className="nav-item">
                <a className="nav-link" href="C:/Users/ikram/OneDrive/Bureau/pfa/Dash/src/pages/tables/tab_absence.html">
              ...
              <div className="col-lg-12 stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">ETUDINATS</h4>
                    <p className="card-description"> la liste des etudiants </p>
          ...
          <footer className="footer">
            <div className="container-fluid clearfix">
              ...
              <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="#" target="_blank"></a>pfa_ikram kourtasse</span>
            </div>
          </footer>
