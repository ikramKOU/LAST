        ...
        <div className="container-fluid page-body-wrapper">
              ...
              <div className="col-lg-12 stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> La gestion d'absences des étudiant </p>
          ...
          <footer className="footer">
            <div className="container-fluid clearfix">
              ...
              <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="" target="_blank">ikram</a> ikramkourtasse1234@gmail.com</span>
            </div>
          </footer>
